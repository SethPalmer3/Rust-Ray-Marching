...
fn main() {
    ...
    let mut march_handler = ray_marcher::marcher::MarcherHandler::new(1000, marcher::MAX_DISTANCE, 50, camera);
    // march_handler.debug = true;
    march_handler.add_scene_object(Sphere::new(Point::new(30.0, -10.0, 0.0), 10.0, Some(SurfaceMaterial{ color: Color::new(1.0, 0.0, 0.0), reflectivity: 1.0 })));
    march_handler.add_scene_object(Sphere::new(Point::new(30.0, 10.0, 0.0), 10.0, Some(SurfaceMaterial{ color: Color::new(0.0, 0.0, 1.0), reflectivity: 0.0 })));
    march_handler.march();
