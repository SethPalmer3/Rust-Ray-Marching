use rand::{self, Rng};
use super::{Vector3D, Point3D, color_data_types::Color, scene_objects::SurfaceMaterial};
...
impl Ray {
    ...
    pub fn scatter(&mut self, surf_normal: &Vector3D, surf_material: &SurfaceMaterial, max_angle_change: f64, back_off_dist: f64) {
